...
@section('page_title') Add Awnser @endsection
@section('table_header')
    <div class="page-header mt-3">
        <h3 class="page-title"> Add Awnser </h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/home">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('awnsers.index') }}">Menage Awnser</a></li>
                <li class="breadcrumb-item">Add a Awnser</li>
            </ol>
        </nav>
    </div>
@endsection
...
@section('content')
    <form class="forms-sample" action="{{ route('awnsers.store') }}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="form-group col-md-6 mt-4">
                <div class="form-check">
                    <label class="form-check-label">
                        <input type="checkbox" name="is-correct" id="is-correct" class="form-check-input" value="1">Is-Correct Awnser <i class="input-helper"></i></label>
                </div>
